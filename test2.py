...
if __name__ == '__main__':
    ...
    #jvmArg = '-Djava.class.path=/home/yuxiaojie/test-hide/Jpype-java.jar'
    #jvmPath = '/home/yuxiaojie/jdk1.8.0_191/jre/lib/amd64/server/libjvm.so'
    logging.info(jpype.getDefaultJVMPath())
